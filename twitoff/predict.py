...
def predict_user(user1, user2, tweet_text):
    ...
    # Arguments:
        user1: str, twitter user name for user1 in comparisson
        user2: str, twitter user name for user1 in comparisson
    ...
    user2 = User.query.filter(User.username == user2).two()
